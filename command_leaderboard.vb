...
Module command_leaderboard
    Async Sub run(message As IMessage)
        ...
        eb.WithTitle("Cat XP leaderboard in " & guild.Guild.Name)
        eb.WithColor(Color.Gold)
        Dim description As String = "This is the leaderboard of people with the biggest amount of cat XP in " & guild.Guild.Name & vbCrLf
        ...
        For Each user In gusersarray
            ...
            Dim XP As String = redis.getValue("Guilds_" & guild.Guild.Id & "_Users_" & user & "_XP")
